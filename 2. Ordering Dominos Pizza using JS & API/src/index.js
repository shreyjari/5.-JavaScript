...
async function getStoreNearAddress(
  ...
  const response = await fetch(
    `https://order.dominos.ca/power/store-locator?type=${orderType}&c=${cityStateZip}&s=${streetAddress}&wasChangedByUser=true&isOrderStarted=false&ignoreWarnings=true`,
    {
      headers: {
        accept:
